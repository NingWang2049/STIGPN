...
class GroupMultiScaleCrop(object):
    ...
    def _sample_crop_size(self, im_size):
        ...
        crop_h = [self.output_size[1] if abs(x - self.output_size[1]) < 3 else x for x in crop_sizes_h]
        crop_w = [self.output_size[0] if abs(x - self.output_size[0]) < 3 else x for x in crop_sizes_w]
